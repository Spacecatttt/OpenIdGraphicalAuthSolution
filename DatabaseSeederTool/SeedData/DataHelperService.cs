...
public class DataHelperService
{
    ...
    /// <usage>
    /// var newOrganization = await dataHelper.CreateOrganizationForUserAsync("owner1@example.com");
    /// </usage>
    ...
    /// <usage>
    /// var addedUsers = await dataHelper.AddUsersToOrganizationAsync(newOrganization.Id, 5);
    /// </usage>
    ...
    /// </summary>
    /// <usage>
    /// var addedGroups = await dataHelper.AddGroupsToOrganizationAsync(newOrganization.Id, 3);
    /// </usage>
    ...
    /// </summary>
    /// <usage>
    /// var addedClients = await dataHelper.AddGroupsToOrganizationAsync(newOrganization.Id, 3);
    /// </usage>
